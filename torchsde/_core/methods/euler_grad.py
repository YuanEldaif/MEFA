...
from .. import base_solver_grad
from ...settings import SDE_TYPES, NOISE_TYPES, LEVY_AREA_APPROXIMATIONS


class Euler_grad(base_solver_grad.BaseSDESolver_grad):
    weak_order = 1.0
    ...
    def __init__(self, sde, **kwargs):
        ...
        super(Euler_grad, self).__init__(sde=sde, **kwargs)

    def step(self, t0, t1, y0, noi, extra0):
        del extra0
        dt = t1 - t0
        # print('dt:', dt)

        f, g_prod = self.sde.f_and_g_prod(t0, y0, noi)
