...
def sdeint(sde,
    ...
    ys, noises, curr_ts, next_ts, extra_solver_state = solver.integrate(y0, ts, extra_solver_state)

    return parse_return(y0, ys, noises, curr_ts, next_ts, extra_solver_state, extra, logqp)
...
def parse_return(y0, ys, noises, curr_ts, next_ts, extra_solver_state, extra, logqp):
    if logqp:
        ...
        if extra:
            return ys, noises, curr_ts, next_ts, extra_solver_state
        else:
            return ys, noises, curr_ts, next_ts
